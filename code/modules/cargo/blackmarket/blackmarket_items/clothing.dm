...
/datum/blackmarket_item/clothing/frontiersmen_armor_fireproof
	...
	desc = "Get it while it's hot! This fireproofed armor and uniform set is made with a pre-Night Of Fire miracle material that renders it almost impervious to flames. The Frontiersmen swear by the stuff. It's kept each of its previous owners safe until they passed away from illness."
	item = /obj/item/storage/box
