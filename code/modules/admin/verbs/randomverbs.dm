...
/client/proc/admin_headset_message(mob/M in GLOB.mob_list, sender = null)
	...
	if (!sender)
		sender = input("Who is the message from?", "Sender") as null|anything in list(RADIO_CHANNEL_CENTCOM, RADIO_CHANNEL_SYNDICATE, RADIO_CHANNEL_TERRAGOV, RADIO_CHANNEL_INTEQ, RADIO_CHANNEL_MINUTEMEN, "Outpost")
		if(!sender)
			return
		switch(sender)
