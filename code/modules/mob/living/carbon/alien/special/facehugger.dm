...
/obj/item/clothing/mask/facehugger_item/proc/Impregnate(mob/living/carbon/target)
	...
	var/obj/item/bodypart/chest/new_host_chest = target.get_bodypart(BODY_ZONE_CHEST)
	if((!new_host_chest || IS_ORGANIC_LIMB(new_host_chest)) && !target.getorgan(/obj/item/organ/body_egg/alien_embryo))
