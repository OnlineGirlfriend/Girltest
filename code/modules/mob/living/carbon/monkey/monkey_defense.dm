				...
				if(prob(40))
					...
					if(AmountUnconscious() < 100 && health > 0)
						...
						visible_message("<span class='danger'>[M] knocks [name] out!</span>", \
										"<span class='userdanger'>[M] knocks you out!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", 5, M)
			...
			if ((prob(95) && health > 0))
				...
				if(AmountUnconscious() < 300)
					...
					visible_message("<span class='danger'>[M] wounds [name]!</span>", \
									"<span class='userdanger'>[M] wounds you!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, M)
					to_chat(M, "<span class='danger'>You wound [name]!</span>")
				else
					visible_message("<span class='danger'>[M] slashes [name]!</span>", \
									"<span class='userdanger'>[M] slashes you!</span>", "<span class='hear'>You hear the sickening sound of a slice!</span>", COMBAT_MESSAGE_RANGE, M)
