...
/mob/living/simple_animal/hostile/guardian/assassin
	...
	playstyle_string = "<span class='holoparasite'>As an <b>assassin</b> type, you do medium damage and have no damage resistance - but you can enter stealth, massively increasing the damage of your next attack and causing it to ignore armor. Stealth is broken when you attack or take damage.</span>"
