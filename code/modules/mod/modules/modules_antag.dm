...
/obj/item/mod/module/energy_shield/on_suit_activation()
	...
	charge_recovery = charge_recovery, lose_multiple_charges = lose_multiple_charges, starting_charges = charges, shield_icon_file = shield_icon_file, shield_icon = shield_icon) //PENTEST CORRECTION
