...
/obj/machinery/plumbing/splitter
	...
	desc = "A chemical splitter for smart chemical factorization. Waits 'til a set of conditions is met and then stops all input and splits the buffer evenly or other in two ducts."
	icon_state = "splitter"
	buffer = 100
	density = FALSE
