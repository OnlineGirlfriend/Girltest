...
/datum/martial_art/cqc/proc/Slam(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(D.body_position == STANDING_UP)
		D.visible_message("<span class='danger'>[A] slams [D] into the ground!</span>", \
						"<span class='userdanger'>You're slammed into the ground by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", null, A)
...
/datum/martial_art/cqc/proc/Kick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat || !D.IsParalyzed())
		D.visible_message("<span class='danger'>[A] kicks [D] back!</span>", \
						"<span class='userdanger'>You're kicked back by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, A)
	...
	if(D.IsParalyzed() && !D.stat)
		...
		D.visible_message("<span class='danger'>[A] kicks [D]'s head, knocking [D.p_them()] out!</span>", \
						"<span class='userdanger'>You're knocked unconscious by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", null, A)
...
/datum/martial_art/cqc/proc/Pressure(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message("<span class='danger'>[A] punches [D]'s neck!</span>", \
					"<span class='userdanger'>Your neck is punched by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/cqc/proc/Consecutive(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(!D.stat)
		...
		D.visible_message("<span class='danger'>[A] strikes [D]'s abdomen, neck and back consecutively</span>", \
						"<span class='userdanger'>Your abdomen, neck and back are struck consecutively by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/cqc/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message("<span class='danger'>[A] [picked_hit_type]ed [D]!</span>", \
					"<span class='userdanger'>You're [picked_hit_type]ed by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, A)
	...
	if(A.resting && !D.stat && !D.IsParalyzed())
		D.visible_message("<span class='danger'>[A] leg sweeps [D]!</span>", \
						"<span class='userdanger'>Your legs are sweeped by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", null, A)
	...
	if(prob(65))
		if(!D.stat || !D.IsParalyzed() || !restraining)
			...
			D.visible_message("<span class='danger'>[A] strikes [D]'s jaw with their hand!</span>", \
							"<span class='userdanger'>Your jaw is struck by [A], you feel disoriented!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", COMBAT_MESSAGE_RANGE, A)
