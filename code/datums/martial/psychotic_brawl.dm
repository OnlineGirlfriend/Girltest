	...
	switch(rand(1,8))
		...
		if(4)
			...
			D.visible_message("<span class='danger'>[A] [atk_verb]s [D]!</span>", \
							"<span class='userdanger'>You're [atk_verb]ed by [A]!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", null, A)
		...
		if(5,6)
			...
			D.visible_message("<span class='danger'>[A] [atk_verb]s [D] with such inhuman strength that it sends [D.p_them()] flying backwards!</span>", \
							"<span class='userdanger'>You're [atk_verb]ed by [A] with such inhuman strength that it sends you flying backwards!</span>", "<span class='hear'>You hear the sickening sound of flesh hitting flesh!</span>", null, A)
