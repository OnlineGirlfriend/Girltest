...
/*/obj/structure/platform/industrial_alt/indestructible/CanPass(atom/movable/mover, border_dir) // PENTEST REMOVAL - we want this platform to be completely impassable
	. = ..()
	if(border_dir & dir)
