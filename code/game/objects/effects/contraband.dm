...
/obj/structure/sign/poster/contraband/random
	...
	random_type = POSTER_ADD_FROM_LIST // what this does is add the SUNS poster, which would usually only be in the terragov poster pool to the contraband pool.
	random_pool = list(
...
/obj/structure/sign/poster/retro/radio
	name = "Radio"
	desc = "A poster advertising one of Nanotrasen's earliest products, a radio. One of its main selling points was a integrated OS and two way automatic translation for Terran Common, and Kalixcian Common, which made it a smash hit. This thing is ancient."
...
/obj/structure/sign/poster/terragov/terragov_enlist //much better.
	name = "Enlist"
