...
/obj/item/paper/contractor_guide/Initialize()
	default_raw_text = {"<p>Welcome agent. Congratulations on your new position as contractor. On top of your already-assigned objectives,
			...
			Syndicate space suit available to you on the uplink. Also provided are your chameleon jumpsuit and mask, both of which can be changed
			...
			<ol>
				...
				other number regardless of whether they were alive or dead.</li>
			...
			to where you sent them off from in several minutes' time. Don't worry, we give you a cut of what we get paid. We pay this into whatever
