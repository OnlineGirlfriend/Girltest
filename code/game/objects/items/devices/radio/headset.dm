...
GLOBAL_LIST_INIT(channel_tokens, list(
	...
	RADIO_CHANNEL_TERRAGOV = RADIO_TOKEN_TERRAGOV,
...
/obj/item/radio/headset/terragov
	name = "\improper TerraGov headset"
...
/obj/item/radio/headset/terragov/captain
	name = "\improper TerraGov official radio headset"
	desc = "Worn by various officials and leaders from TerraGov. Fancy hat not included."
	keyslot2 = new /obj/item/encryptionkey/heads/captain
	command = TRUE

/obj/item/radio/headset/terragov/alt
	name = "\improper TerraGov bowman headset"
	desc = "Worn by bureaucrats. Protects ears from flashbangs."
	icon_state = "solgov_headset_alt"

/obj/item/radio/headset/terragov/alt/captain
	name = "\improper TerraGov official bowman headset"
	desc = "Worn by various officials and leaders from TerraGov. Fancy hat not included. Protects ears from flashbangs."
	keyslot2 = new /obj/item/encryptionkey/heads/captain
	command = TRUE
